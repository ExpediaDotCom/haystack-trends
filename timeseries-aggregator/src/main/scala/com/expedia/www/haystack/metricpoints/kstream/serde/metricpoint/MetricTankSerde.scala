...
object MetricTankSerde extends AbstractMetricPointSerde {
  ...
  override def serializeMetricPoint(metricPoint: MetricPoint): Array[Byte] = {
  ...
  override def deserializeMetricPoint(data: Array[Byte]): MetricPoint = {
